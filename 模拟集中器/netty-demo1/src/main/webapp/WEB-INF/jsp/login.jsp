	  ...
	  <div class="layui-form-item" style="position: relative;">
	   <!-- <label class="layui-form-label">验证码</label>-->
	    <div class="layui-input-block" style="width: 40%;">
	      <input type="text" name="vCode" lay-verify="required" autocomplete="off" placeholder="请输入验证码" maxlength="4" class="layui-input">
	    </div>
	     <a href="javascript:void(0);" class="" id="vCode" style=""><img src="${ctx}/resources/images/logo/validateCode.png" /></a>
	  </div>
	    ...
	    $.ajax({
			  ...
			  success: function(result){
				...
				if (status == 0) {
					...
					layer.msg(msg, {icon: 5, anim: 6,time:1500});			
