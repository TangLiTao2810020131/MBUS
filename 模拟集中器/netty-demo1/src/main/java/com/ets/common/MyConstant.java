...
public class MyConstant {
    ...
    public static final Integer OPERATION_TYPE_0 = 0; //购水
    public static final Integer OPERATION_TYPE_1 = 1; //退水
    public static final Integer OPERATION_TYPE_2 = 2; //补水
    public static final Integer OPERATION_TYPE_3 = 3; //换房
    public static final Integer OPERATION_TYPE_4 = 4; //更换水表
    public static final Integer OPERATION_TYPE_5 = 5; //普通指令
    public static final Integer OPERATION_TYPE_6 = 6; //清零
    public static final Integer OPERATION_TYPE_7 = 7; //冲红
