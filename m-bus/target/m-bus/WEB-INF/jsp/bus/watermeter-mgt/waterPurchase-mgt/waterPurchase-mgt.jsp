...
<div class="tableHtml" style="margin-left: 210px;height: 100%;background: #FFFFFF;">
	<div class="top-btn">
		<div class="layui-btn-group">
			<%--<shiro:hasPermission name="现金购水">--%>
			<button class="layui-btn" id="cashBtn">现金购水</button>
			<%--</shiro:hasPermission>--%>
		</div>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer'], function(){
        ...
        $("#cashBtn").click(function(){
            ...
            com.checkOpen("现金购水","${ctx}/waterpurchasemgt/buyIndex.action",['1000px', '600px'],tableWhere);
        });
