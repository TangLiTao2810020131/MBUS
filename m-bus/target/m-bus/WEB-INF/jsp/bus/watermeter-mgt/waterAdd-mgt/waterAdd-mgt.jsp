...
<div class="tableHtml" style="margin-left: 210px;height: 100%;background: #FFFFFF;">
    <div class="top-btn">
        <div class="layui-btn-group" style="position: relative;">
          <%--  <shiro:hasPermission name="按房间补水">--%>
            <button class="layui-btn" id="roomBtn">按房间补水</button>
          <%--  </shiro:hasPermission>--%>
         <%--   <shiro:hasPermission name="按楼层补水">--%>
            <button class="layui-btn" id="buildBtn">按楼层补水</button>
        <%--    </shiro:hasPermission>--%>
            <%--<shiro:hasPermission name="按导入补水">--%>
            <button class="layui-btn" id="importBtn">按导入补水</button>
       <%--     </shiro:hasPermission>--%>
        </div>
...
<form class="layui-form" action="" id="formHtml" lay-filter="updForm">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" id="apartmentId" placeholder="请输入" autocomplete="off" class="layui-input"
                       maxlength="20">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" id="roomNum" placeholder="请输入" autocomplete="off" class="layui-input" maxlength="20"
                       onchange="fangjian()">
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer'], function () {
        ...
        var urls = '${ctx}/wateraddmgt/listData.action';
        ...
        $("#roomBtn").click(function () {
            com.checkOpen("按房间补水", "${ctx}/wateraddmgt/waterAddRoom.action", ['1000px', '600px'],reload());
        })
        /*-----按楼层补水-----*/
        $("#buildBtn").click(function () {
            com.checkOpen("按楼层补水", "${ctx}/wateraddmgt/waterAddBuild.action", ['1100px', '700px'],reload());
        })
        /*-----按导入补水-----*/
        $("#importBtn").click(function () {
            com.pageOpen("按导入补水", "${ctx}/wateraddmgt/waterAddImport.action", ['1000px', '565px'],reload());
        })
    });
