...
<div class="tableHtml" style="margin-left: 210px;height: 100%;background: #FFFFFF;">
    <div class="top-btn">
        <div class="layui-btn-group" style="position: relative;">
            <%--<shiro:hasPermission name="退水">--%>
            <button class="layui-btn" id="quitBtn"> &nbsp;退 &nbsp;水&nbsp;</button>
           <%-- </shiro:hasPermission>--%>
        </div>
...
//主动加载jquery模块
        ...
        layui.use(['jquery', 'layer'], function () {
            ...
            var urls = '${ctx}/waterquitmgt/listData.action';
            ...
            $("#quitBtn").click(function () {
                com.checkOpen("退水", "${ctx}/waterquitmgt/waterQuit.action", ['1000px', '600px'],reload());
            })
        });
    }
