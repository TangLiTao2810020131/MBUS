...
<div class="tableHtml" style="margin-left: 210px;height: 100%;background: #FFFFFF;">
    <div class="top-btn">
        <div class="layui-btn-group">
            <%--<shiro:hasPermission name="最新抄表导出">--%>
...
<script type="text/html" id="handle">
    <%--<shiro:hasPermission name="查看最新抄表">--%>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer'], function () {
        ...
        var urls = '${ctx}/newReadMeter/listData.action';
        ...
        table.on('tool(tableBox)', function(obj){
            var data = obj.data;
            if(obj.event === 'detail'){
                com.pageOpen("查看最新抄表","${ctx}/newReadMeter/findNewReadMeter.action?id="+data.id,['800px', '550px']);
            }
        });
    ...
    layui.config({
        ...
        $(function(){
            $("#exportBtn").on("click",function(){
                var str="区域,公寓,楼栋,楼层,房间号,水表编号,操作状态,阀门状态,模块状态,抄表日期,购水量,补水量,透支水量,总用水量";
                var name="最新抄表";
                var url="${ctx}/newReadMeter/export.action?str="+str+"&name="+name+"&startTime="+$('#startTime').val()+
