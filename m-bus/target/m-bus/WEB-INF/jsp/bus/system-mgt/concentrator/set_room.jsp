...
<div class="tableHtml" style="height: 100%;background: #FFFFFF;">
    <div class="top-btn">
        <div class="layui-btn-group">
            <button class="layui-btn" id="cashBtn">绑定房间</button>
        </div>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer'], function(){
        ...
        var urls = '${ctx}/concentrator/findRoomInfo.action?concentratorId='+$("#concentratorId").val();
        ...
        $("#cashBtn").click(function(){
            ...
            if (checkStatus.data.length==0) {
                ...
                parent.layer.confirm('确定为选中的房间设置集中器!',{
                    title:'温馨提示',
                    btn:['确定','取消'],
                },function(){
                    var str=""
                    ...
                    $.ajax({
                        url:"${ctx}/concentrator/addRooomConcentrator.action",
                        data:{str:str,concentratorId:$("#concentratorId").val()},
                        dataType:"json",
                        type:"post",
                        success:function(){
                            parent.layer.msg("为集中器分配房间成功!",{
                                icon:1,
                                time:2000
                            },function(){
