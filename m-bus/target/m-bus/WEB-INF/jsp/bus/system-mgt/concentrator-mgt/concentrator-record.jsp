...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer'], function () {
        ...
        var urls2 = '${ctx}/concentratormgt/recordListData.action?id='+$("#tid").val();
        ...
        table.on('tool(tableBox2)', function(obj){
            var data = obj.data;
            if(obj.event === 'detail'){
                com.pageOpen("查看指令记录","${ctx}/concentratormgt/findInstructionsById.action?id="+data.id,['800px', '550px']);
            }
        });
