package com.ets.bus.reportQuery.entity.addwaterrecord;

/**
 * 补水记录实体类
 */
public class AddWaterRecord
{
    private String id;//id
    private String water_meter_info_id;//房间信息id
    private String serial_number;//流水号
    private String user_id;//操作人id
    private String user_name;//操作人姓名
    private String supplement_water;//补水量
    private String remark;//备注
    private Integer current_status;//操作状态
    private String current_status_name;//操作状态名称
    private String create_time;//创建时间
    private String update_time;//更新时间
    private Integer type;//补水类型
    private String type_name;//类型名称
    private Integer redrush;//是否红冲
    private Double operat_money;//操作金额
    private String concentrator_id;//集中器id
    private String ip_address;//集中器id
    ...
    public String getSupplement_water() {
        return supplement_water;
    }

    public void setSupplement_water(String supplement_water) {
        this.supplement_water = supplement_water;
    }
    ...
    public Double getOperat_money() {
        return operat_money;
    }

    public void setOperat_money(Double operat_money) {
        this.operat_money = operat_money;
    }
