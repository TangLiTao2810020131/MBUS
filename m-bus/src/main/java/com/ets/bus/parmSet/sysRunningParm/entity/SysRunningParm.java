package com.ets.bus.parmSet.sysRunningParm.entity;

import java.sql.Timestamp;
import java.util.Date;

public class SysRunningParm {
    private String id;
    private Integer  del_status;//'是否删除（0：否，1：是）'
    private Integer  effect_status;//'是否生效（0：否，1：是  有在其他相应功能中手动下发或更新，才能被运用和生效）'
    private Double warn_water;//报警水量
    private Double valve_water;//关阀水量（吨
    private Double over_water;//最大透支水量
    private Double hoard_water;//最大囤积量
