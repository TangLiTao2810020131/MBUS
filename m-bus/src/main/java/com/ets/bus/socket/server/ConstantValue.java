...
/**
 * @author 姚轶文
 * @create 2019- 04-08 9:54
 */
public class ConstantValue {

    public static final int  HEAD_DATA = 0x0E;
    public static final byte PROTOCOL_START = 0x0E; //起始位 0EH
    public static final byte PROTOCOL_END = 0x0F; //结束位 0FH
    ...
    public static final byte CONCENTRATOR_VERSION=0x12;//集中器版本
    public static final byte CONCENTRATOR_TYPE=0x26;//设备类型
...
//    public static final int MAX_DATA_LENGTH = 2062; //最大长度=最小长度+数据域长度2048字节
    ...
    public static final byte RETURN_RNT_ERROR = 0x01; //购水补水返回状态码 正常
    ...
    public static final byte VERSION = 0x12; //协议版本
    public static final byte BASE_TYPE = 0x26; //设备类型
