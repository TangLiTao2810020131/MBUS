...
<title>智能用水管理系统</title>
  ...
  <link rel="stylesheet" href="${ctx}/resources/css/mylayui.css" media="all">
<style type="text/css">
* {
	padding: 0;
	margin: 0;
...
<body class="layui-layout-body" id="outbody">
	...
	<div class="layui-layout layui-layout-admin container">
		<div class="layui-header" id="layui-header">
			...
			<div class="layui-logo" style="color:#ffffff;top: -5px;left: 15px;width: auto;"><span style="cursor: pointer;font-size:19px;" onclick="window.location.reload();">智能用水管理系统</span></div>
		...
		<div class="layui-side layui-bg-bai"><!---->
			<div class="layui-side-scroll sideClo">
				<!-- 左侧导航区域 -->
				<ul class="layui-nav layui-nav-tree" lay-shrink="all" lay-filter="test" id="navList">
				 ...
				 <li class="layui-nav-item">
                     <%--<shiro:hasPermission name="水表管理">--%>
			        <a href="javascript:void(0);"><i class="layui-icon layui-icon-console"></i>水表管理</a>
                   <%--  </shiro:hasPermission>--%>
			        <dl class="layui-nav-child">
			          <dd>
                        <%--  <shiro:hasPermission name="购水管理">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/waterpurchasemgt/waterPurchaseMgt.action' page_name="水表管理 / 购水管理" >购水管理</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
			          <dd>
                          <%--<shiro:hasPermission name="补水管理">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/wateraddmgt/waterAddMgt.action' page_name="水表管理 / 补水管理">补水管理</a>
                         <%-- </shiro:hasPermission></dd>--%>
			          <dd>
                          <%--<shiro:hasPermission name="退水管理">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/waterquitmgt/waterQuitMgt.action' page_name="水表管理 / 退水管理" >退水管理</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
			          <dd>
                         <%-- <shiro:hasPermission name="控水换房管理">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/waterroommgt/waterRoomMgt.action' page_name="水表管理 / 控水换房管理">控水换房管理</a>
                          <%--</shiro:hasPermission>--%>
                      </dd>
			          <dd>
                     <%--     <shiro:hasPermission name="房间水量清零">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/waterreset/waterResetIndex.action' page_name="水表管理 / 房间水量清零">房间水量清零</a>
                          <%--</shiro:hasPermission>--%>
                      </dd>
			          <dd>
                          <%--<shiro:hasPermission name="水表交易明细">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/watermetedetails/waterMeteDetails.action' page_name="水表管理 / 水表交易明细">水表交易明细</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
			        </dl>
			      </li>
					<li class="layui-nav-item">
                        <%--<shiro:hasPermission name="设备管理">--%>
						<a href="javascript:void(0);"><i class="layui-icon layui-icon-chart-screen"></i>设备管理</a>
                        <%--</shiro:hasPermission>--%>
						<dl class="layui-nav-child">
							<dd>
                                <%--<shiro:hasPermission name="集中器管理">--%>
                                <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/concentratormgt/concentratorMgt.action' page_name="系统管理 / 集中器管理">集中器管理</a>
                                <%--</shiro:hasPermission>--%>
                            </dd>
							<dd>
                                <%--<shiro:hasPermission name="房间管理">--%>
                                <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/floormgt/floorMgt.action' page_name="系统管理 / 房间管理">房间管理</a>
                              <%--  </shiro:hasPermission>--%>
                            </dd>
							<dd>
                              <%--  <shiro:hasPermission name="历史命令">--%>
                                <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/historyCommand/historyCommand.action' page_name="系统管理 / 历史命令">历史命令</a>
                                <%--</shiro:hasPermission>--%>
                            </dd>
							<dd>
                            <%--    <shiro:hasPermission name="最新抄表">--%>
                                <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/newReadMeter/newReadMeter.action' page_name="系统管理 / 最新抄表">最新抄表</a>
                                <%--</shiro:hasPermission>--%>
                            </dd>
							<dd>
                                <%--<shiro:hasPermission name="历史抄表">--%>
                                <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/waterCollectRecord/list.action' page_name="系统管理 / 历史抄表">历史抄表</a>
                              <%--  </shiro:hasPermission>--%>
                            </dd>
							<dd>
                                <%--<shiro:hasPermission name="报警记录">--%>
                                <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/warning/list.action' page_name="系统管理 / 报警记录">报警记录</a>
                               <%-- </shiro:hasPermission>--%>
                            </dd>
						</dl>
					</li>
			      <li class="layui-nav-item">
			        ...
			        <dl class="layui-nav-child">
			          <dd>
                          <%--<shiro:hasPermission name="冲红记录">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/redrushRecord/index.action' page_name="报表查询 / 冲红记录">冲红记录</a>
                        <%--  </shiro:hasPermission>--%>
                      </dd>
			          <dd>
                        <%--  <shiro:hasPermission name="购水记录">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/reportquery/waterPayRecord.action' page_name="报表查询 / 购水记录">购水记录</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
			          <dd>
                         <%-- <shiro:hasPermission name="补水记录">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/reportquery/waterAddDtls.action' page_name="报表查询 / 补水记录">补水记录</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
			          <dd>
                         <%-- <shiro:hasPermission name="退水记录">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/reportquery/waterQuitDtls.action' page_name="报表查询 / 退水记录">退水记录</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
						<dd>
                          <%--  <shiro:hasPermission name="清零记录">--%>
                            <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/waterResetRecord/index.action' page_name="报表查询 / 清零记录">清零记录</a>
                           <%-- </shiro:hasPermission>--%>
                        </dd>
			          <dd>
                          <%--<shiro:hasPermission name="换表历史记录">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/replaceRecord/index.action' page_name="报表查询 / 换表历史记录">换表历史记录</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
			          <dd>
                        <%--  <shiro:hasPermission name="控水换房记录">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/replaceRoomRecord/index.action' page_name="报表查询 / 控水换房记录">控水换房记录</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
			          <dd>
                       <%--   <shiro:hasPermission name="用水房间日报">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/roomDaily/index.action' page_name="报表查询 / 用水房间日报">用水房间日报</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
			          <dd>
                         <%-- <shiro:hasPermission name="用水房间月报">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/roomMonth/index.action' page_name="报表查询 / 用水房间月报">用水房间月报</a>
                          <%--</shiro:hasPermission>--%>
                      </dd>
			        </dl>
			      </li>			     
			      <li class="layui-nav-item">
			        ...
			        <dl class="layui-nav-child">
						<dd>
                            <%--<shiro:hasPermission name="区域管理">--%>
                            <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/region/tree.action' page_name="系统管理 / 区域管理">区域管理</a>
                            <%--</shiro:hasPermission>--%>
                        </dd>
						<dd>
                          <%--  <shiro:hasPermission name="水表管理">--%>
                            <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/waterMeterMgt/waterMeterMgt.action' page_name="系统管理 / 水表管理">水表管理</a>
                           <%-- </shiro:hasPermission>--%>
                        </dd>
			          ...
			          <dd>
                          <%--<shiro:hasPermission name="采集管理">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/clctapplmgt/clctApplMgt.action' page_name="系统管理 / 采集应用管理">采集管理</a>
                        <%--  </shiro:hasPermission>--%>
                      </dd>
			          <dd>
                         <%-- <shiro:hasPermission name="操作日志">--%>
                          <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/operationlog/operationLog.action' page_name="系统管理 / 职工操作日志">操作日志</a>
                         <%-- </shiro:hasPermission>--%>
                      </dd>
						<dd>
                          <%--  <shiro:hasPermission name="登录日志">--%>
                            <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/loginLog/list.action' page_name="系统管理 / 职工登录日志">登录日志</a>
                           <%-- </shiro:hasPermission>--%>
                        </dd>
			        </dl>
			      </li>
			      <li class="layui-nav-item">
					 <%-- <shiro:hasPermission name="参数设置">--%>
			        <a href="javascript:void(0);"><i class="layui-icon layui-icon-util"></i>参数设置</a>
					<%--  </shiro:hasPermission>--%>
			        <dl class="layui-nav-child">
			          <dd>
						  <%--<shiro:hasPermission name="系统运行参数">--%>
						  <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/sysrunningparm/sysRunningParm.action' page_name="参数设置 / 系统运行参数">系统运行参数</a>
						 <%-- </shiro:hasPermission>--%>
					  </dd>
						<dd>
							<%--<shiro:hasPermission name="房间类型参数">--%>
							<a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/roomtype/roomTypeParm.action' page_name="参数设置 / 房间类型参数">房间类型参数</a>
								<%--</shiro:hasPermission>--%></dd>
						<dd>
							<%--<shiro:hasPermission name="读写卡参数">--%>
							<a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/readWritecard/readWriteCardParm.action' page_name="参数设置 / 读写卡参数">读写卡参数</a>
							<%--</shiro:hasPermission>--%>
						</dd>
			          <dd>
						  <%--<shiro:hasPermission name="一卡通终端">--%>
						  <a class="marginL-15" href="javascript:void(0);" menu_url='${ctx}/smartcard/smartCard.action' page_name="参数设置 / 一卡通终端">一卡通终端</a>
						 <%-- </shiro:hasPermission>--%>
					  </dd>
		...
		<div class="layui-body" style="height: 95%;background:#F2F2F2;top: 96px;" id="layui-body">
			<!--导航-->
			...
			<!-- 底部固定区域 -->
			<div class="layui-footer" style="background-color: #b0b0b3bf;left: 50px;"align="center">
				技术支持：<a href="http://www.etslink.cn/" target="_blank">安徽银通物联有限公司</a>
			</div>
		</div>
	</div>
