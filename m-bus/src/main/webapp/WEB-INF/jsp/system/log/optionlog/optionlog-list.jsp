							...
							<div class="layui-form layuiadmin-card-header-auto marginBottom">
								<div class="demoTable">
									...
									<div class="layui-inline">
										...
										<div class="layui-input-inline">
											<input type="text" name="username" id="username"
												placeholder="请输入操作用户" autocomplete="off" class="layui-input">
										</div>
									</div>
									...
									<div class="layui-inline">
										...
										<div class="layui-input-inline">
											<input type="text" name="oprtime" id="oprtime"
	...
	<script>
		...
		layui.use('table', function() {
			...
			table.render({
				...
				/*  ,{field: 'isclose', title: '操作', minWidth: 80,toolbar:'#handle', align:'center'}*/
				] ], //,data: ${list}
				url : '${ctx}/optionlog/listData.action', //,where: {username: 'admin', id: 123} //如果无需传递额外参数，可不加该参数 //method: 'post' //如果无需自定义HTTP类型，可不加该参数 //,skin: 'line' //表格风格
				id : 'myTable',
				even : true,
				page : true, //是否显示分页
				limits : [ 15, 20, 50 ],
			...
			table.on('tool(myTable)', function(obj) {
				...
				if (obj.event === 'detail') {
					layer.open({
						...
						fixed : false, //不固定
						maxmin : true,
						content : '${ctx}/optionlog/info.action?id=' + data.id
					});
				}
			});
