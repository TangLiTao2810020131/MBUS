...
<form class="layui-form layui-form-pane ml30" action="" id="formHtml" style="margin-top: 20px;" lay-filter="updForm">
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="workerAccount" id="workerAccount" lay-verify="required|workerAccount" autocomplete="off" class="layui-input" maxlength="20">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label label-120">登录名</label>
      <div class="layui-input-inline">
        <input type="text" name="workerName" id="workerName" lay-verify="required|workerName" autocomplete="off" class="layui-input" maxlength="20">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
      <div class="layui-inline">
          <label class="layui-form-label label-120">账号密码</label>
          <div class="layui-input-inline">
              <input type="password" name="password" id="password" lay-verify="required|password" autocomplete="off" class="layui-input" maxlength="20">
          </div>
      </div>
    <div class="layui-inline">
      <label class="layui-form-label label-120">职员姓名</label>
      <div class="layui-input-inline">
        <input type="text" name="realName" id="realName" lay-verify="required|realName" autocomplete="off" class="layui-input" maxlength="20">
      </div>
    </div>
  ...
  <div class="layui-form-item">
      <div class="layui-inline">
          ...
          <div class="layui-input-inline">
              <input type="text" name="email" id="email" lay-verify="required|email" autocomplete="off" class="layui-input" maxlength="20">
          </div>
...
<script type="text/javascript">
	...
	layui.use(['jquery', 'layer'], function(){
		...
		layui.use('form', function(){  
            ...
            form.verify({
                workerAccount:[/[a-zA-Z0-9_]{6,18}$/, '账号必须是6到18位数字和字母'],
                password:[/[a-zA-Z0-9]{6,18}$/, '密码必须是6-18数字和字母'],
			...
			form.on('submit(confirmBtn)', function (data) {
                ...
                $.ajax({
                    type : "POST", //提交方式
                    url : "${ctx}/workermgt/save.action",//路径
                    data : obj,//数据，这里使用的是Json格式进行传输
                    dataType:"json",
                    async:false,
                    success : function(result) {//返回数据根据结果进行相应的处理
			  ...
			  /*  parent.layer.close(index);//关闭layer*/
			    /*$('#iframe',parent.document).attr('src', 'html/pmsn-control/worker-mgt/worker-mgt.html');*/
			});
