        ...
        <form class="layui-form" action="">
            ...
            <div class="">
                <c:forEach items="${list }" var="role">
                  ...
                  <c:forEach items="${workerRoleList }" var="wr">
                               <c:if test="${role.id == wr.roleId }">checked="checked" </c:if>
                        </c:forEach>
                        >
                    </div>
                </c:forEach>
            ...
            <div class="clear"></div>
            <div class="layui-form-item" style="margin-top:125px">
                <div class="text-center">
                    <a class="layui-btn" lay-submit="" lay-filter="demo1">确定</a>
                    <a type="reset" class="layui-btn layui-btn-primary" id="canleBtn">取消</a>
                </div>
            </div>
        </form>
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(demo1)', function(data){
            ...
            $.ajax({
                type : "POST", //提交方式
                url : '${ctx}/workermgt/saveRole.action',//路径
