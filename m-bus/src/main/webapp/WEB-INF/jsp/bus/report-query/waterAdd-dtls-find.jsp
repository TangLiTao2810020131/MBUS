...
<form class="layui-form layui-form-pane ml30" action="" id="formHtml" style="margin-top:40px;margin-left:80px;" lay-filter="updForm">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${br.supplement_water}" autocomplete="off" class="layui-input" disabled>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label label-120" title="操作状态">操作状态：</label>
            <div class="layui-input-inline">
                <input type="text" value="${br.current_status_name}" autocomplete="off" class="layui-input" disabled>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label label-120" title="补水类型">补水类型：</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${br.operat_money}" autocomplete="off" class="layui-input" disabled>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label label-120" title="创建时间">补水日期：</label>
            <div class="layui-input-inline">
