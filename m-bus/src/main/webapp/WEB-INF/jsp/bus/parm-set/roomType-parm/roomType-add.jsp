	...
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="type_num" placeholder="请输入类型编号" id="type_num"  loninput="this.value=this.value.replace(/\D/g,'')"  lay-verify="required|type_num" autocomplete="off" class="layui-input" maxlength="20">
			</div>
		</div>
		<div class="layui-inline">
			<label class="layui-form-label label-120" title="类型名称" style="width:140px;">类型名称</label>
			<div class="layui-input-inline">
				<input type="text" name="type_name" placeholder="请输入类型名称" id="type_name" lay-verify="required|type_name" autocomplete="off" class="layui-input" maxlength="20">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="effect_time" placeholder="请输入选择参数生效时间" id="effect_time"  lay-verify="required" autocomplete="off" class="layui-input" maxlength="20">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="buy_money" id="buyMoney" placeholder="请输入购水单价(元/m³)" onkeyup="this.value=/^\d+\.?\d{0,2}$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)" lay-verify="required|buy_money" autocomplete="off" class="layui-input" maxlength="20">
			</div>
		</div>
		<div class="layui-inline">
			<label class="layui-form-label label-120" title="退水单价(元/m³)" style="width:140px;">退水单价(元/m³)</label>
			<div class="layui-input-inline">
				<input type="text" name="return_money" id="returnMoney" placeholder="请输入退水单价(元/m³)" onkeyup="this.value=/^\d+\.?\d{0,2}$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)" lay-verify="required|return_money" autocomplete="off" class="layui-input" maxlength="20">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="warn_water" id="warnWater" placeholder="请输入报警水量(m³)" onkeyup="this.value=/^\d+\.?\d{0,2}$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)" lay-verify="required|warn_water" autocomplete="off" class="layui-input" maxlength="20">
			</div>
		</div>
		<div class="layui-inline">
			<label class="layui-form-label label-120" title="关阀水量(m³)" style="width:140px;">关阀水量(m³)</label>
			<div class="layui-input-inline">
				<input type="text" name="valve_water"  placeholder="请输入关阀水量(m³)" onkeyup="this.value=/^\d+\.?\d{0,2}$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)" lay-verify="required|valve_water" autocomplete="off" class="layui-input" maxlength="20">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="over_water" placeholder="请输入最大透支量(m³)" onkeyup="this.value=/^\d+\.?\d{0,2}$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)" lay-verify="required|over_water" autocomplete="off" class="layui-input" maxlength="20">
			</div>
		</div>
		<div class="layui-inline">
			<label class="layui-form-label label-120" title="最大囤积量(m³)" style="width:140px;">最大囤积量(m³)</label>
			<div class="layui-input-inline">
				<input type="text" name="hoard_water"  placeholder="请输入最大囤积量(m³)"  onkeyup="this.value=/^\d+\.?\d{0,2}$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)" lay-verify="required|hoard_water|number" autocomplete="off" class="layui-input" maxlength="20">
			</div>
		</div>
	</div>
	<div class="layui-form-item window-block-btn">
		<div class="layui-input-block">
			<button type="button"  style="margin-right: 50%" class="layui-btn layui-btn-primary window-btn" id="canleBtn" style="margin-right: 47%">取消</button>
    ...
    layui.use(['jquery', 'layer','form'], function(){
        ...
        layui.use('form', function(){
            ...
            form.on('submit(confirmBtn)', function (data) {
                ...
                //以下是ajax
                $.ajax({
                    url:"${ctx}/roomtype/addRoomType.action",
        ...
        form.verify({
            ...
            type_name:function(value, item) {
				if(!/^[\u4e00-\u9fa5]{0,}$/.test(value.trim())){
                    ...
                    var flag=0;
                    $.ajax({
                        url:'${ctx}/roomtype/checkRoomTypeName.action',
                        data:{roomTypeName:value.trim()},
                        dataType:'json',
                        async:false,
                        success:function(result){
                            if(result=='1')
