        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="code" id = "code" class="layui-input" lay-verify="required|code" maxlength="20" placeholder="请输入区域编号">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">
                    区域名称</label>
                <div class="layui-input-inline">
                    <input type="text" name="name" id = "name"  lay-verify="required|name" class="layui-input" maxlength="20" placeholder="请输入区域名称">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item window-block-btn">
            <div class="layui-input-block">
                <button type="button" class="layui-btn layui-btn-primary window-btn" id="canleBtn" style="margin-right:47%">
                    取消</button>
                <button type="button" class="layui-btn window-btn" lay-submit="" id="confirmBtn" lay-filter="confirmBtn">
                    确定</button>
            </div>
        </div>
    </div>
