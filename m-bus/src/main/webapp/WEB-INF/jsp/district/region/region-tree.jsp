...
<div id="LAY_app">
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side " style="background:#FFFFFF">
            <div class="treename" style="margin-top: 10px;text-align: center;width: 100%;">
                <span>公寓房间列表</span>
            </div>
        ...
        <div class="layui-body">
            <div class="layadmin-tabsbody-item">
                <iframe name="iframe_content" id="iframe_content" frameborder="0" width="100%" height="100%" style="margin-left:20px" src="${ctx}/region/list.action"></iframe>
            </div>
        </div>
...
<script>
    ...
    layui.config({
        ...
        dtree.render({
            ...
            iframe: {
                ...
                iframeUrl: "${ctx}/region/list.action", // iframe路由到的地址
                iframeLoad: "all", // 表示点击任意节点加载iframe
                iframeDefaultRequest: {level:"level",parentId:"parentId"} // 这里就将nodeId这个参数名称改为了areaId这个名称
    ...
    function raloadts(){
        window.frames["iframe_content"].window.aa();//刷新table数据
    }
